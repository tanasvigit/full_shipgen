# Virtual Queue — Module Audit Report

**Generated:** 2026-06-17T12:33:57.965Z
**Route:** `/queue`
**Module score:** 93/100
...
| Forms validate / workflows | **PASS** | queue-call-in: SKIP |
| Action buttons | **WARN** | 0 working, 0 broken, 1 total audited |
| RBAC direct URL | **PASS** | yard_admin: ACCESSIBLE; yard_manager: ACCESSIBLE; gate_operator: BLOCKED_AS_EXPECTED; yard_coordinator: ACCESSIBLE |
...
| yard_coordinator | brand-home | PASS |  |
...
## Screenshots
- [`../e2e/screenshots/queue.png`](../e2e/screenshots/queue.png)
- [`screenshots/queue.png`](screenshots/queue.png)
- [`screenshots/virtual_queue.png`](screenshots/virtual_queue.png)

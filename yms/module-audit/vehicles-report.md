# Vehicle Operations Monitor — Module Audit Report

**Generated:** 2026-06-17T12:33:57.970Z
**Route:** `/vehicles`
**Module score:** 79/100
...
| Drawers open/close | **FAIL** | vehicle-drawer: open=false close=false |
...
## Screenshots
- [`../e2e/screenshots/vehicles.png`](../e2e/screenshots/vehicles.png)
- [`screenshots/vehicles.png`](screenshots/vehicles.png)

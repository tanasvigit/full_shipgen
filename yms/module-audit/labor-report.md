# Labor Management — Module Audit Report

**Generated:** 2026-06-17T12:33:57.974Z
**Route:** `/labor`
**Module score:** 81/100
...
| Drawers open/close | **FAIL** | labor-drawer: open=false close=false |
| Forms validate / workflows | **PASS** | labor-assign: SKIP |
...
| Responsive layout | **PASS** | mobile-small:PASS, mobile-small:SKIP, mobile-small:SKIP, mobile-small:SKIP, mobile-small:PASS, mobile-medium:PASS, mobile-medium:SKIP, mobile-medium:SKIP, mobile-medium:SKIP, mobile-medium:PASS, mobile-large:PASS, mobile-large:SKIP, mobile-large:SKIP, mobile-large:SKIP, mobile-large:PASS, tablet:PASS, tablet:SKIP, tablet:SKIP, tablet:SKIP, tablet:PASS, laptop:PASS, laptop:SKIP, laptop:SKIP, laptop:SKIP, laptop:PASS, laptop-hd:PASS, laptop-hd:SKIP, laptop-hd:SKIP, laptop-hd:SKIP, laptop-hd:PASS, desktop:PASS, desktop:SKIP, desktop:SKIP, desktop:SKIP, desktop:PASS |

## Admin JWT audit
- Status: **ACCESSIBLE**
- URL after navigation: `/labor`
...
| yard_admin | event-feed-toggle | FAIL | locator.click: Timeout 2000ms exceeded.
Call log:
[2m  - wa |
...
## Screenshots
- [`../e2e/screenshots/labor.png`](../e2e/screenshots/labor.png)
- [`screenshots/labor.png`](screenshots/labor.png)

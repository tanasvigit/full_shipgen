# System Settings — Module Audit Report

**Generated:** 2026-06-17T12:33:58.011Z
**Route:** `/settings`
**Module score:** 60/100
...
| RBAC direct URL | **FAIL** | yard_admin: FAIL; yard_manager: FAIL; gate_operator: UNEXPECTED_ACCESS; yard_coordinator: FAIL |
...
### critical
- gate_operator unexpected access to /settings

### high
- JWT admin audit did not reach /settings (timeout)

...
export const AddEquipmentDialog = ({ open, onOpenChange, onCreated }) => {
  ...
  return (
    ...
    >
      <DialogContent data-testid="add-equipment-dialog" className="max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="font-display text-lg flex items-center gap-2">
            <Wrench className="w-5 h-5" /> Add Equipment
          </DialogTitle>
          <DialogDescription className="text-[12px] text-slate-500">
            Register yard equipment. Code is generated automatically (e.g. EQ-001).
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-2">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Field label="Status" required>
              ...
              >
                {EQUIPMENT_STATUSES.filter((s) => !["ASSIGNED", "IN_USE"].includes(s)).map((s) => (
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Field label="Registration / Asset Number">
              <input
                className={inputCls}
          ...
          <Field label="Zone / Default Location">
            <input
              className={inputCls}
          ...
          <DialogFooter className="gap-2 sm:gap-2 pt-2">
            ...
            <button
              type="submit"
              data-testid="add-equipment-submit"
              disabled={submitting}

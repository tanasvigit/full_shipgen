# Service: work-order-actions

**Source:** `packages\fleetops\addon\services\work-order-actions.js`
...
**Modal:**
- **show**: modals/send-work-order — Opens modal; confirm handler may call save/API; decline may rollback

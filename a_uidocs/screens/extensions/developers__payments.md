...
| **Template** | `packages/registry-bridge/addon/templates/developers/payments.hbs` |
| **Controller** | `packages\registry-bridge\addon\controllers\developers\payments` |
| **Route** | `packages\registry-bridge\addon\routes\developers\payments.js` |

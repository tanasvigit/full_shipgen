...
| **Template** | `packages/ledger/addon/templates/payments/gateways.hbs` |
| **Controller** | `packages\ledger\addon\controllers\payments\gateways` |
| **Route** | `packages\ledger\addon\routes\payments\gateways.js` |

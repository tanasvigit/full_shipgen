# Screen: payments/gateways/index/new

| Property | Value |
|----------|-------|
| **Engine** | Ledger |
| **Route name** | `ledger.payments.gateways.index.new` |
| **URL** | `/ledger/payments/gateways/index/new` |
| **Template** | `packages/ledger/addon/templates/payments/gateways/index/new.hbs` |
| **Controller** | `packages\ledger\addon\controllers\payments\gateways\index\new.js` |
| **Route** | `packages\ledger\addon\routes\payments\gateways\index\new.js` |
...
- **Enter:** Navigate to `/ledger/payments/gateways/index/new`
...
| Permission | Effect |
|------------|--------|
| `ledger create gateway` | redirect/warning — see route for target |

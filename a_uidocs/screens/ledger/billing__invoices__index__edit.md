# Screen: billing/invoices/index/edit

| Property | Value |
|----------|-------|
| **Engine** | Ledger |
| **Route name** | `ledger.billing.invoices.index.edit` |
| **URL** | `/ledger/billing/invoices/index/edit` |
| **Template** | `packages/ledger/addon/templates/billing/invoices/index/edit.hbs` |
| **Controller** | `packages\ledger\addon\controllers\billing\invoices\index\edit.js` |
| **Route** | `packages\ledger\addon\routes\billing\invoices\index\edit.js` |
...
- **Enter:** Navigate to `/ledger/billing/invoices/index/edit`
...
| Permission | Effect |
|------------|--------|
| `ledger update invoice` | redirect/warning — see route for target |

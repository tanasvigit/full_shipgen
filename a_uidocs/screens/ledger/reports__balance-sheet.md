# Screen: reports/balance-sheet

| Property | Value |
|----------|-------|
| **Engine** | Ledger |
| **Route name** | `ledger.reports.balance_sheet` |
| **URL** | `/ledger/reports/balance-sheet` |
| **Template** | `packages/ledger/addon/templates/reports/balance-sheet.hbs` |
| **Controller** | `packages\ledger\addon\controllers\reports\balance-sheet.js` |
| **Route** | `packages\ledger\addon\routes\reports\balance-sheet.js` |
...
- **Enter:** Navigate to `/ledger/reports/balance-sheet`

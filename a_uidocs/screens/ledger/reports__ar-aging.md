# Screen: reports/ar-aging

| Property | Value |
|----------|-------|
| **Engine** | Ledger |
| **Route name** | `ledger.reports.ar_aging` |
| **URL** | `/ledger/reports/ar-aging` |
| **Template** | `packages/ledger/addon/templates/reports/ar-aging.hbs` |
| **Controller** | `packages\ledger\addon\controllers\reports\ar-aging.js` |
| **Route** | `packages\ledger\addon\routes\reports\ar-aging.js` |
...
- Template: `{{#if this.data.grand_total}}`
...
- **Enter:** Navigate to `/ledger/reports/ar-aging`
...
- `{{#if this.data.grand_total}}` — branch UI visibility

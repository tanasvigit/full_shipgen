...
| **Template** | `packages/ledger/addon/templates/payments/wallets/index.hbs` |
| **Controller** | `packages\ledger\addon\controllers\payments\wallets\index.js` |
| **Route** | `packages\ledger\addon\routes\payments\wallets\index.js` |
...
|---------------|-----------|------|--------|
| column.owner | `subject.name` | yes | yes |
...
| column.frozen | `is_frozen_label` | yes | yes |
...
| Interaction | Detail |
|-------------|--------|
| Data load | `store.query('ledger-wallet')` |
...
### Controller actions/tabs (`packages/ledger/addon/controllers/payments/wallets/index.js`)
...
|--------|---------|---------------|
| common.refresh | `walletActions.refresh` | `—` |

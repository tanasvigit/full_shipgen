...
| **Template** | `packages/ledger/addon/templates/billing/invoices.hbs` |
| **Controller** | `packages\ledger\addon\controllers\billing\invoices` |
| **Route** | `packages\ledger\addon\routes\billing\invoices.js` |

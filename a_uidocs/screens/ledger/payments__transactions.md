...
| **Template** | `packages/ledger/addon/templates/payments/transactions.hbs` |
| **Controller** | `packages\ledger\addon\controllers\payments\transactions` |
| **Route** | `packages\ledger\addon\routes\payments\transactions.js` |

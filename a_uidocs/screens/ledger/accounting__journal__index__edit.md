# Screen: accounting/journal/index/edit

| Property | Value |
|----------|-------|
| **Engine** | Ledger |
| **Route name** | `ledger.accounting.journal.index.edit` |
| **URL** | `/ledger/accounting/journal/index/edit` |
| **Template** | `packages/ledger/addon/templates/accounting/journal/index/edit.hbs` |
| **Controller** | `packages\ledger\addon\controllers\accounting\journal\index\edit.js` |
| **Route** | `packages\ledger\addon\routes\accounting\journal\index\edit.js` |
...
- **Enter:** Navigate to `/ledger/accounting/journal/index/edit`
...
| Permission | Effect |
|------------|--------|
| `ledger update journal-entry` | redirect/warning — see route for target |

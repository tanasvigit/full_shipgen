# Screen: accounting/accounts/index

| Property | Value |
|----------|-------|
| **Engine** | Ledger |
| **Route name** | `ledger.accounting.accounts` |
| **URL** | `/ledger/accounting/accounts` |
| **Template** | `packages/ledger/addon/templates/accounting/accounts/index.hbs` |
| **Controller** | `packages\ledger\addon\controllers\accounting\accounts\index.js` |
| **Route** | `packages\ledger\addon\routes\accounting\accounts\index.js` |
...
| Interaction | Detail |
|-------------|--------|
| Data load | `store.query('ledger-account')` |
...
- **Enter:** Navigate to `/ledger/accounting/accounts`
...
### Controller actions/tabs (`packages/ledger/addon/controllers/accounting/accounts/index.js`)
...
**Injected services:** `accountActions`, `tableContext`, `intl`
...
|--------|---------|---------------|
| common.refresh | `accountActions.refresh` | `—` |
| common.new | `accountActions.transition` | `—` |

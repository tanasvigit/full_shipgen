# Screen: maintenance/maintenances/index/details

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.maintenance.maintenances.index.details` |
| **URL** | `/fleet-ops/maintenance/maintenances/index/details` |
| **Template** | `packages/fleetops/addon/templates/maintenance/maintenances/index/details.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\maintenance\maintenances\index\details.js` |
| **Route** | `packages\fleetops\addon\routes\maintenance\maintenances\index\details.js` |
...
- `fleet-ops delete maintenance`
- `fleet-ops view maintenance`

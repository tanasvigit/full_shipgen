...
| **Template** | `packages/fleetops/addon/templates/settings/payments.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\settings\payments.js` |
| **Route** | `packages\fleetops\addon\routes\settings\payments.js` |

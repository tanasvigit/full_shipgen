# Screen: management/vehicles/index/details/schedules

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.management.vehicles.index.details.schedules` |
| **URL** | `/fleet-ops/management/vehicles/index/details/schedules` |
| **Template** | `packages/fleetops/addon/templates/management/vehicles/index/details/schedules.hbs` |
| **Controller** | _none / parent controller_ |
| **Route** | `packages\fleetops\addon\routes\management\vehicles\index\details\schedules.js` |
...
- **Enter:** Navigate to `/fleet-ops/management/vehicles/index/details/schedules`
...
**Source:** `packages\fleetops\addon\components\vehicle\details\schedules.hbs`
...
> **Full merged spec:** [MASTER__schedule-detail-complete.md](./MASTER__schedule-detail-complete.md)

# Screen: management/fleets/index/details/virtual

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.management.fleets.index.details.virtual` |
| **URL** | `/fleet-ops/management/fleets/index/details/virtual` |
| **Template** | `packages/fleetops/addon/templates/management/fleets/index/details/virtual.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\management\fleets\index\details\virtual.js` |
| **Route** | `packages\fleetops\addon\routes\management\fleets\index\details\virtual.js` |
...
- **Enter:** Navigate to `/fleet-ops/management/fleets/index/details/virtual`

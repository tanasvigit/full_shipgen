# Screen: management/fleets/index/details/drivers

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.management.fleets.index.details.drivers` |
| **URL** | `/fleet-ops/management/fleets/index/details/drivers` |
| **Template** | `packages/fleetops/addon/templates/management/fleets/index/details/drivers.hbs` |
| **Controller** | _none / parent controller_ |
| **Route** | `packages\fleetops\addon\routes\management\fleets\index\details\drivers.js` |
...
- **Enter:** Navigate to `/fleet-ops/management/fleets/index/details/drivers`
...
**Source:** `packages\fleetops\addon\components\fleet\driver-listing.hbs`

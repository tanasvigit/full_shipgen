# Screen: connectivity/telematics/index/details/devices

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.connectivity.telematics.index.details.devices` |
| **URL** | `/fleet-ops/connectivity/telematics/index/details/devices` |
| **Template** | `packages/fleetops/addon/templates/connectivity/telematics/index/details/devices.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\connectivity\telematics\index\details\devices.js` |
| **Route** | `packages\fleetops\addon\routes\connectivity\telematics\index\details\devices.js` |
...
- **Enter:** Navigate to `/fleet-ops/connectivity/telematics/index/details/devices`

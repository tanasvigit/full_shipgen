# Screen: management/places/index/details/map

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.management.places.index.details.map` |
| **URL** | `/fleet-ops/management/places/index/details/map` |
| **Template** | `packages/fleetops/addon/templates/management/places/index/details/map.hbs` |
| **Controller** | _none / parent controller_ |
| **Route** | `packages\fleetops\addon\routes\management\places\index\details\map.js` |
...
- **Enter:** Navigate to `/fleet-ops/management/places/index/details/map`

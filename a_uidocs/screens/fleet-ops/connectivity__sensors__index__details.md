# Screen: connectivity/sensors/index/details

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.connectivity.sensors.index.details` |
| **URL** | `/fleet-ops/connectivity/sensors/index/details` |
| **Template** | `packages/fleetops/addon/templates/connectivity/sensors/index/details.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\connectivity\sensors\index\details.js` |
| **Route** | `packages\fleetops\addon\routes\connectivity\sensors\index\details.js` |

# Screen: management/vendors/integrated

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.management.vendors.integrated` |
| **URL** | `/fleet-ops/management/vendors/integrated` |
| **Template** | `packages/fleetops/addon/templates/management/vendors/integrated.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\management\vendors\integrated.js` |
| **Route** | `packages\fleetops\addon\routes\management\vendors\integrated.js` |
...
- **Enter:** Navigate to `/fleet-ops/management/vendors/integrated`

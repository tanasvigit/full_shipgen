# Screen: management/drivers/index/details/orders

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.management.drivers.index.details.orders` |
| **URL** | `/fleet-ops/management/drivers/index/details/orders` |
| **Template** | `packages/fleetops/addon/templates/management/drivers/index/details/orders.hbs` |
| **Controller** | _none / parent controller_ |
| **Route** | `packages\fleetops\addon\routes\management\drivers\index\details\orders.js` |
...
- **Enter:** Navigate to `/fleet-ops/management/drivers/index/details/orders`

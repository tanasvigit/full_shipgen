# Screen: management/fleets/index/details/vehicles

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.management.fleets.index.details.vehicles` |
| **URL** | `/fleet-ops/management/fleets/index/details/vehicles` |
| **Template** | `packages/fleetops/addon/templates/management/fleets/index/details/vehicles.hbs` |
| **Controller** | _none / parent controller_ |
| **Route** | `packages\fleetops\addon\routes\management\fleets\index\details\vehicles.js` |
...
- **Enter:** Navigate to `/fleet-ops/management/fleets/index/details/vehicles`
...
|-------|---------------------|
| `Fleet::VehicleListing` | TBD |

---

## 15. Composed components (full UI)

### `Fleet::VehicleListing`

**Source:** `packages\fleetops\addon\components\fleet\vehicle-listing.hbs`

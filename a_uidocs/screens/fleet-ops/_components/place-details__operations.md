# place detail tab: operations

| Property | Value |
|----------|-------|
| **Parent screen** | [place detail complete](../MASTER__place-detail-complete.md) |
| **Route** | `fleet-ops.management.places.index.details.operations` |
| **Component** | `Place::Operations` |
...
`packages/fleetops/addon/components/place/operations.js`

# place detail tab: documents

| Property | Value |
|----------|-------|
| **Parent screen** | [place detail complete](../MASTER__place-detail-complete.md) |
| **Route** | `fleet-ops.management.places.index.details.documents` |
| **Component** | `Place::Documents` |
...
`packages/fleetops/addon/components/place/documents.js`

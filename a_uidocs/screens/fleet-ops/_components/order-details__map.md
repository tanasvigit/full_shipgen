# Order detail tab: map

| Property | Value |
|----------|-------|
| **Parent screen** | [Order detail complete](../MASTER__order-detail-complete.md) |
| **Component** | `Order::Details::Map` |
| **Source** | `packages/fleetops/addon/components/order/details/map.hbs` |
...
`packages/fleetops/addon/components/order/details/map.js`

# Order detail tab: documents

| Property | Value |
|----------|-------|
| **Parent screen** | [Order detail complete](../MASTER__order-detail-complete.md) |
| **Component** | `Order::Details::Documents` |
| **Source** | `packages/fleetops/addon/components/order/details/documents.hbs` |
...
| Field / i18n key |
|----------------|
| i18n:order.fields.documents-panel-title |
...
**Tasks:** `queueFile`, `removeFile` — use `.perform()`, UI bound via `.isRunning`


### Template conditionals

- `{{#if this.queueFile.isRunning}}` — branch UI visibility
...
`packages/fleetops/addon/components/order/details/documents.js`

# Order detail tab: comments

| Property | Value |
|----------|-------|
| **Parent screen** | [Order detail complete](../MASTER__order-detail-complete.md) |
| **Component** | `Order::Details::Comments` |
| **Source** | `packages/fleetops/addon/components/order/details/comments.hbs` |
...
| Field / i18n key |
|----------------|
| i18n:order.fields.comments-title |
...
`packages/fleetops/addon/components/order/details/comments.js`

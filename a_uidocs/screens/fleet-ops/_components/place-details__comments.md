# place detail tab: comments

| Property | Value |
|----------|-------|
| **Parent screen** | [place detail complete](../MASTER__place-detail-complete.md) |
| **Route** | `fleet-ops.management.places.index.details.comments` |
| **Component** | `Place::Comments` |
...
`packages/fleetops/addon/components/place/comments.js`

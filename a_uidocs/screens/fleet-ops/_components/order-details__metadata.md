# Order detail tab: metadata

| Property | Value |
|----------|-------|
| **Parent screen** | [Order detail complete](../MASTER__order-detail-complete.md) |
| **Component** | `Order::Details::Metadata` |
| **Source** | `packages/fleetops/addon/components/order/details/metadata.hbs` |
...
`packages/fleetops/addon/components/order/details/metadata.js`

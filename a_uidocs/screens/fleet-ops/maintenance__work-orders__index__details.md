# Screen: maintenance/work-orders/index/details

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.maintenance.work_orders.index.details` |
| **URL** | `/fleet-ops/maintenance/work-orders/index/details` |
| **Template** | `packages/fleetops/addon/templates/maintenance/work-orders/index/details.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\maintenance\work-orders\index\details.js` |
| **Route** | `packages\fleetops\addon\routes\maintenance\work-orders\index\details.js` |
...
| Send to Vendor | controller `actionButtons` | see disabled rules in controller |

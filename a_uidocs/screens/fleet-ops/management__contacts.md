...
| **Template** | `packages/fleetops/addon/templates/management/contacts.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\management\contacts.js` |
| **Route** | `packages\fleetops\addon\routes\management\contacts.js` |

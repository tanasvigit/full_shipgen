...
| **Template** | `packages/fleetops/addon/templates/maintenance/schedules.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\maintenance\schedules` |
| **Route** | `packages\fleetops\addon\routes\maintenance\schedules.js` |

# Screen: management/vehicles/index/details/positions

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.management.vehicles.index.details.positions` |
| **URL** | `/fleet-ops/management/vehicles/index/details/positions` |
| **Template** | `packages/fleetops/addon/templates/management/vehicles/index/details/positions.hbs` |
| **Controller** | _none / parent controller_ |
| **Route** | `packages\fleetops\addon\routes\management\vehicles\index\details\positions.js` |
...
- **Enter:** Navigate to `/fleet-ops/management/vehicles/index/details/positions`

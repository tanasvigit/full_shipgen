# Screen: maintenance/parts/index/details

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.maintenance.parts.index.details` |
| **URL** | `/fleet-ops/maintenance/parts/index/details` |
| **Template** | `packages/fleetops/addon/templates/maintenance/parts/index/details.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\maintenance\parts\index\details.js` |
| **Route** | `packages\fleetops\addon\routes\maintenance\parts\index\details.js` |

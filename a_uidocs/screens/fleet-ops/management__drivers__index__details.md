# Screen: management/drivers/index/details

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.management.drivers.index.details` |
| **URL** | `/fleet-ops/management/drivers/index/details` |
| **Template** | `packages/fleetops/addon/templates/management/drivers/index/details.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\management\drivers\index\details.js` |
| **Route** | `packages\fleetops\addon\routes\management\drivers\index\details.js` |
...
- **Enter:** Navigate to `/fleet-ops/management/drivers/index/details`
...
### Controller actions/tabs (`packages/fleetops/addon/controllers/management/drivers/index/details.js`)

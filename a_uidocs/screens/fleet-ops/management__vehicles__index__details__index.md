# Screen: management/vehicles/index/details/index
...
| **Template** | `packages/fleetops/addon/templates/management/vehicles/index/details/index.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\management\vehicles\index\details.js` |
| **Route** | `packages\fleetops\addon\routes\management\vehicles\index\details\index.js` |
...
**Source:** `packages\fleetops\addon\components\vehicle\details.hbs`
...
#### `vehicle-actions.create()`


#### `vehicle-actions.update()`


#### `vehicle-actions.confirmContinueWithUnsavedChanges()`
...
#### `vehicle-actions.transitionTo()`


#### `vehicle-actions.createTask()`


#### `vehicle-actions.updateTask()`


#### `vehicle-actions.saveTask()`


#### `vehicle-actions.modalTask()`


#### `vehicle-actions.deleteTask()`


#### `vehicle-actions.getRecordName()`


#### `vehicle-actions.createNewInstance()`


#### `vehicle-actions.can()`


#### `vehicle-actions.cannot()`

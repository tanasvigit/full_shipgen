# Screen: management/drivers/index/details/schedule

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.management.drivers.index.details.schedule` |
| **URL** | `/fleet-ops/management/drivers/index/details/schedule` |
| **Template** | `packages/fleetops/addon/templates/management/drivers/index/details/schedule.hbs` |
| **Controller** | _none / parent controller_ |
| **Route** | `packages\fleetops\addon\routes\management\drivers\index\details\schedule.js` |
...
- **Enter:** Navigate to `/fleet-ops/management/drivers/index/details/schedule`
...
**Source:** `packages\fleetops\addon\components\driver\schedule.hbs`

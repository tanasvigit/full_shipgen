# Screen: management/vehicles/index/details/work-orders

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.management.vehicles.index.details.work_orders` |
| **URL** | `/fleet-ops/management/vehicles/index/details/work-orders` |
| **Template** | `packages/fleetops/addon/templates/management/vehicles/index/details/work-orders.hbs` |
| **Controller** | _none / parent controller_ |
| **Route** | `packages\fleetops\addon\routes\management\vehicles\index\details\work-orders.js` |
...
- **Enter:** Navigate to `/fleet-ops/management/vehicles/index/details/work-orders`
...
|-------|---------------------|
| `Vehicle::Details::WorkOrders` | TBD |

---

## 15. Composed components (full UI)

### `Vehicle::Details::WorkOrders`

**Source:** `packages\fleetops\addon\components\vehicle\details\work-orders.hbs`

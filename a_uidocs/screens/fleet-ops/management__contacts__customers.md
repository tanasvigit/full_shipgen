# Screen: management/contacts/customers

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.management.contacts.customers` |
| **URL** | `/fleet-ops/management/contacts/customers` |
| **Template** | `packages/fleetops/addon/templates/management/contacts/customers.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\management\contacts\customers.js` |
| **Route** | `packages\fleetops\addon\routes\management\contacts\customers.js` |
...
- **Enter:** Navigate to `/fleet-ops/management/contacts/customers`
...
**Injected services:** `customerActions`

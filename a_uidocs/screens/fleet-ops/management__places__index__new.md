# Screen: management/places/index/new

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.management.places.index.new` |
| **URL** | `/fleet-ops/management/places/index/new` |
| **Template** | `packages/fleetops/addon/templates/management/places/index/new.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\management\places\index\new.js` |
| **Route** | `packages\fleetops\addon\routes\management\places\index\new.js` |
...
- **Enter:** Navigate to `/fleet-ops/management/places/index/new`
...
| Permission | Effect |
|------------|--------|
| `fleet-ops create place` | redirect/warning — see route for target |
...
**Injected services:** `placeActions`, `hostRouter`, `intl`, `notifications`, `events`

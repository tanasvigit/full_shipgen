# Screen: management/vendors/index/edit

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.management.vendors.index.edit` |
| **URL** | `/fleet-ops/management/vendors/index/edit` |
| **Template** | `packages/fleetops/addon/templates/management/vendors/index/edit.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\management\vendors\index\edit.js` |
| **Route** | `packages\fleetops\addon\routes\management\vendors\index\edit.js` |
...
- **Enter:** Navigate to `/fleet-ops/management/vendors/index/edit`
...
| Permission | Effect |
|------------|--------|
| `fleet-ops update vendor` | redirect/warning — see route for target |

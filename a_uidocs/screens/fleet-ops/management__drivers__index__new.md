# Screen: management/drivers/index/new

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.management.drivers.index.new` |
| **URL** | `/fleet-ops/management/drivers/index/new` |
| **Template** | `packages/fleetops/addon/templates/management/drivers/index/new.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\management\drivers\index\new.js` |
| **Route** | `packages\fleetops\addon\routes\management\drivers\index\new.js` |
...
- **Enter:** Navigate to `/fleet-ops/management/drivers/index/new`
...
| Permission | Effect |
|------------|--------|
| `fleet-ops create driver` | redirect/warning — see route for target |
...
**Injected services:** `driverActions`, `hostRouter`, `intl`, `notifications`, `events`

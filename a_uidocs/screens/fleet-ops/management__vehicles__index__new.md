# Screen: management/vehicles/index/new

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.management.vehicles.index.new` |
| **URL** | `/fleet-ops/management/vehicles/index/new` |
| **Template** | `packages/fleetops/addon/templates/management/vehicles/index/new.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\management\vehicles\index\new.js` |
| **Route** | `packages\fleetops\addon\routes\management\vehicles\index\new.js` |
...
- **Enter:** Navigate to `/fleet-ops/management/vehicles/index/new`
...
| Permission | Effect |
|------------|--------|
| `fleet-ops create vehicle` | redirect/warning — see route for target |
...
**Injected services:** `store`, `hostRouter`, `intl`, `notifications`, `events`

# Screen: connectivity/devices/index/edit

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.connectivity.devices.index.edit` |
| **URL** | `/fleet-ops/connectivity/devices/index/edit` |
| **Template** | `packages/fleetops/addon/templates/connectivity/devices/index/edit.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\connectivity\devices\index\edit.js` |
| **Route** | `packages\fleetops\addon\routes\connectivity\devices\index\edit.js` |
...
- **Enter:** Navigate to `/fleet-ops/connectivity/devices/index/edit`
...
**Source:** `packages\fleetops\addon\components\device\form.hbs`
...
| Permission | Effect |
|------------|--------|
| `fleet-ops update device` | redirect/warning — see route for target |

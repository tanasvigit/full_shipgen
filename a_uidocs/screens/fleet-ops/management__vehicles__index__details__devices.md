# Screen: management/vehicles/index/details/devices

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.management.vehicles.index.details.devices` |
| **URL** | `/fleet-ops/management/vehicles/index/details/devices` |
| **Template** | `packages/fleetops/addon/templates/management/vehicles/index/details/devices.hbs` |
| **Controller** | _none / parent controller_ |
| **Route** | `packages\fleetops\addon\routes\management\vehicles\index\details\devices.js` |
...
- **Enter:** Navigate to `/fleet-ops/management/vehicles/index/details/devices`
...
**Source:** `packages\fleetops\addon\components\device\manager.hbs`

**Buttons:** Attach device, Detach

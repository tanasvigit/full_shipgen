# Screen: management/places/index/details/comments

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.management.places.index.details.comments` |
| **URL** | `/fleet-ops/management/places/index/details/comments` |
| **Template** | `packages/fleetops/addon/templates/management/places/index/details/comments.hbs` |
| **Controller** | _none / parent controller_ |
| **Route** | `packages\fleetops\addon\routes\management\places\index\details\comments.js` |
...
- **Enter:** Navigate to `/fleet-ops/management/places/index/details/comments`

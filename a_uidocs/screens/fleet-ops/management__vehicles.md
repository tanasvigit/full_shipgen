...
| **Template** | `packages/fleetops/addon/templates/management/vehicles.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\management\vehicles` |
| **Route** | `packages\fleetops\addon\routes\management\vehicles.js` |

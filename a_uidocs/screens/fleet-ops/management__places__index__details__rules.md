# Screen: management/places/index/details/rules

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.management.places.index.details.rules` |
| **URL** | `/fleet-ops/management/places/index/details/rules` |
| **Template** | `packages/fleetops/addon/templates/management/places/index/details/rules.hbs` |
| **Controller** | _none / parent controller_ |
| **Route** | `packages\fleetops\addon\routes\management\places\index\details\rules.js` |
...
- **Enter:** Navigate to `/fleet-ops/management/places/index/details/rules`

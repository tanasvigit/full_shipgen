# Screen: connectivity/devices/index/new

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.connectivity.devices.index.new` |
| **URL** | `/fleet-ops/connectivity/devices/index/new` |
| **Template** | `packages/fleetops/addon/templates/connectivity/devices/index/new.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\connectivity\devices\index\new.js` |
| **Route** | `packages\fleetops\addon\routes\connectivity\devices\index\new.js` |
...
- **Enter:** Navigate to `/fleet-ops/connectivity/devices/index/new`
...
**Injected services:** `deviceActions`, `hostRouter`, `intl`, `notifications`, `events`

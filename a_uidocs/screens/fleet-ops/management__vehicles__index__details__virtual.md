# Screen: management/vehicles/index/details/virtual

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.management.vehicles.index.details.virtual` |
| **URL** | `/fleet-ops/management/vehicles/index/details/virtual` |
| **Template** | `packages/fleetops/addon/templates/management/vehicles/index/details/virtual.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\management\vehicles\index\details\virtual.js` |
| **Route** | `packages\fleetops\addon\routes\management\vehicles\index\details\virtual.js` |
...
- **Enter:** Navigate to `/fleet-ops/management/vehicles/index/details/virtual`

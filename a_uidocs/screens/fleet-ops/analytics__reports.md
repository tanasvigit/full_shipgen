...
| **Template** | `packages/fleetops/addon/templates/analytics/reports.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\analytics\reports` |
| **Route** | `packages\fleetops\addon\routes\analytics\reports.js` |

...
| **Template** | `packages/fleetops/addon/templates/maintenance/parts.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\maintenance\parts` |
| **Route** | `packages\fleetops\addon\routes\maintenance\parts.js` |

# Screen: management/places/index/details/activity

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.management.places.index.details.activity` |
| **URL** | `/fleet-ops/management/places/index/details/activity` |
| **Template** | `packages/fleetops/addon/templates/management/places/index/details/activity.hbs` |
| **Controller** | _none / parent controller_ |
| **Route** | `packages\fleetops\addon\routes\management\places\index\details\activity.js` |
...
- **Enter:** Navigate to `/fleet-ops/management/places/index/details/activity`

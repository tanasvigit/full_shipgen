# Screen: connectivity/telematics/index/details/sensors

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.connectivity.telematics.index.details.sensors` |
| **URL** | `/fleet-ops/connectivity/telematics/index/details/sensors` |
| **Template** | `packages/fleetops/addon/templates/connectivity/telematics/index/details/sensors.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\connectivity\telematics\index\details\sensors.js` |
| **Route** | `packages\fleetops\addon\routes\connectivity\telematics\index\details\sensors.js` |
...
- **Enter:** Navigate to `/fleet-ops/connectivity/telematics/index/details/sensors`

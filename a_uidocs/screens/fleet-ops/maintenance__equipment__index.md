# Screen: maintenance/equipment/index

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.maintenance.equipment` |
| **URL** | `/fleet-ops/maintenance/equipment` |
| **Template** | `packages/fleetops/addon/templates/maintenance/equipment/index.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\maintenance\equipment\index.js` |
| **Route** | `packages\fleetops\addon\routes\maintenance\equipment\index.js` |
...
| column.serial-number | `serial_number` | yes | yes |
| column.manufacturer | `manufacturer` | yes | yes |
...
| Interaction | Detail |
|-------------|--------|
| Data load | `store.query('equipment')` |
...
- **Enter:** Navigate to `/fleet-ops/maintenance/equipment`
...
**Source:** `packages\fleetops\addon\components\equipment\card.hbs`
...
### Controller actions/tabs (`packages/fleetops/addon/controllers/maintenance/equipment/index.js`)
...
**Injected services:** `equipmentActions`, `intl`, `appCache`
...
|--------|---------|---------------|
| common.new | `equipmentActions.transition` | `—` |
| common.import | `equipmentActions.import` | `—` |

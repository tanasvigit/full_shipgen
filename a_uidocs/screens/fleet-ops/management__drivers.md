...
| **Template** | `packages/fleetops/addon/templates/management/drivers.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\management\drivers` |
| **Route** | `packages\fleetops\addon\routes\management\drivers.js` |

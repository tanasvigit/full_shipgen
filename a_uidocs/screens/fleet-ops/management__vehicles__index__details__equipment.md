# Screen: management/vehicles/index/details/equipment

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.management.vehicles.index.details.equipment` |
| **URL** | `/fleet-ops/management/vehicles/index/details/equipment` |
| **Template** | `packages/fleetops/addon/templates/management/vehicles/index/details/equipment.hbs` |
| **Controller** | _none / parent controller_ |
| **Route** | `packages\fleetops\addon\routes\management\vehicles\index\details\equipment.js` |
...
- **Enter:** Navigate to `/fleet-ops/management/vehicles/index/details/equipment`
...
> **Full merged spec:** [MASTER__equipment-detail-complete.md](./MASTER__equipment-detail-complete.md)

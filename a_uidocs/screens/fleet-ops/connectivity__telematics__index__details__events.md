# Screen: connectivity/telematics/index/details/events

| Property | Value |
|----------|-------|
| **Engine** | FleetOps |
| **Route name** | `fleet_ops.connectivity.telematics.index.details.events` |
| **URL** | `/fleet-ops/connectivity/telematics/index/details/events` |
| **Template** | `packages/fleetops/addon/templates/connectivity/telematics/index/details/events.hbs` |
| **Controller** | `packages\fleetops\addon\controllers\connectivity\telematics\index\details\events.js` |
| **Route** | `packages\fleetops\addon\routes\connectivity\telematics\index\details\events.js` |
...
- **Enter:** Navigate to `/fleet-ops/connectivity/telematics/index/details/events`

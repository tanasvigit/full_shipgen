...
|----------|-------|
| **Engine** | Pallet |
| **Route name** | `pallet.inventory` |
| **URL** | `/pallet/inventory` |
| **Template** | `packages/pallet/addon/templates/inventory/index.hbs` |
| **Controller** | `packages\pallet\addon\controllers\inventory\index.js` |
| **Route** | `packages\pallet\addon\routes\inventory\index.js` |
...
- **Enter:** Navigate to `/pallet/inventory`
...
### Controller actions/tabs (`packages/pallet/addon/controllers/inventory/index.js`)
...
**Query params:** `page`, `limit`, `sort`, `product`, `warehouse`, `batch`, `status`

# Screen: inventory/expired-stock

| Property | Value |
|----------|-------|
| **Engine** | Pallet |
| **Route name** | `pallet.inventory.expired_stock` |
| **URL** | `/pallet/inventory/expired-stock` |
| **Template** | `packages/pallet/addon/templates/inventory/expired-stock.hbs` |
| **Controller** | `packages\pallet\addon\controllers\inventory\expired-stock.js` |
| **Route** | `packages\pallet\addon\routes\inventory\expired-stock.js` |
...
- **Enter:** Navigate to `/pallet/inventory/expired-stock`
...
### Controller actions/tabs (`packages/pallet/addon/controllers/inventory/expired-stock.js`)

# Screen: products/index/edit

| Property | Value |
|----------|-------|
| **Engine** | Pallet |
| **Route name** | `pallet.products.index.edit` |
| **URL** | `/pallet/products/index/edit` |
| **Template** | `packages/pallet/addon/templates/products/index/edit.hbs` |
| **Controller** | `packages\pallet\addon\controllers\products\index\edit.js` |
| **Route** | `packages\pallet\addon\routes\products\index\edit.js` |
...
- **Enter:** Navigate to `/pallet/products/index/edit`

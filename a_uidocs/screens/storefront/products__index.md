...
|----------|-------|
| **Engine** | Storefront |
| **Route name** | `storefront.products` |
| **URL** | `/storefront/products` |
| **Template** | `packages/storefront/addon/templates/products/index.hbs` |
| **Controller** | `packages\storefront\addon\controllers\products\index.js` |
| **Route** | `packages\storefront\addon\routes\products\index.js` |
...
|-------|------------------|------------|
| t "storefront.products.index.manage-addons" | `—` | |
| t "storefront.common.new" | `—` | |
| t "storefront.common.import" | `—` | |
...
- **Enter:** Navigate to `/storefront/products`

# Screen: console/account/index

| Property | Value |
|----------|-------|
| **Engine** | Console |
| **Route name** | `console.console.account` |
| **URL** | `/console/account` |
| **Template** | `console/app/templates/console/account/index.hbs` |
| **Controller** | `console\app\controllers\console\account\index.js` |
| **Route** | `console\app\routes\console\account\index.js` |
...
| t "common.email" | `—` | text | |
| t "common.phone" | `—` | text | |
| t "common.date-of-birth" | `—` | text | |
| t "common.timezone" | `—` | text | |
| (input) | `this.user.phone` | primary | |
...
- **Enter:** Navigate to `/console/account`

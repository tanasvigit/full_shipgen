 ...
 * routePoints: [[lat, lng], ...] stop waypoints snapped via Google Routes/Directions APIs
 * routeTrails: [{ points, color?, highlighted? }] live GPS trails (drawn as-is, not re-routed)
 */

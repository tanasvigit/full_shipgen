      ...
      <div className="p-6 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
        {loading ? (
          ...
          wallets.map((w) => {
            ...
            const balanceLabel = formatMoney(w.balance);
            return (
              <div
                key={w.id}
              ...
              >
                ...
                <div className="text-[10px] font-mono uppercase tracking-wider text-[#4B5563] mt-1">{normalizeDisplayCurrency(w.currency)}</div>

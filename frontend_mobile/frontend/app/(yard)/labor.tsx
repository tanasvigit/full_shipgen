...
import { filterLaborRows } from "@/src/services/laborService";
      ...
      >
        ...
        {data?.summary ? (
          <View style={styles.summaryRow}>
            <Chip label="Teams" value={data.summary.total} />
            <Chip label="On duty" value={data.summary.onDuty} />
            <Chip label="Available" value={data.summary.available} />
